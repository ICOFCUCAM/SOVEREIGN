  ...
  return (
    <div className="bg-[#070707] text-white">
      ...
      <div id="top" className="relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto grid min-h-[920px] max-w-[1640px] grid-cols-1 items-center gap-10 px-8 py-20 lg:px-12 xl:min-h-[960px] xl:grid-cols-[28fr_72fr] xl:gap-6">
