        ...
        <div className="relative z-10 mx-auto grid min-h-[820px] max-w-[1540px] grid-cols-1 items-center gap-14 px-8 py-20 lg:px-12 xl:min-h-[980px] xl:grid-cols-[38fr_62fr] xl:gap-12">
          ...
          <div className="max-w-xl">
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
              <button onClick={() => nav("/console")}
                className="group inline-flex items-center justify-center gap-2.5 rounded bg-gradient-to-b from-gold-300 to-gold-600 px-6 py-3.5 text-sm font-bold uppercase tracking-[0.08em] text-[#1c1407] shadow-[inset_0_1px_0_rgba(255,255,255,0.3),0_10px_26px_-10px_rgba(0,0,0,0.65)] transition hover:from-gold-200 hover:to-gold-500">
                Launch Dispatch
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <button onClick={() => nav(PROCUREMENT_ROUTE)}
              className="group inline-flex items-center gap-3 rounded bg-gradient-to-b from-gold-300 to-gold-600 px-8 py-4 text-sm font-bold uppercase tracking-[0.08em] text-[#1c1407] shadow-[inset_0_1px_0_rgba(255,255,255,0.3),0_10px_26px_-10px_rgba(0,0,0,0.65)] transition hover:from-gold-200 hover:to-gold-500">
