      ...
      <main>
        ...
        <section className="border-t border-white/[0.06] px-8 py-24 lg:px-12">
          <div className="mx-auto max-w-4xl">
            <div className="flex items-center gap-3"><span className="h-px w-7 bg-gold-500/55" aria-hidden /><span className="text-[11px] font-semibold uppercase tracking-[0.3em] text-gold-400">What is an Official Record?</span></div>
            <h1 className="mt-4 max-w-3xl font-serif text-[2.5rem] font-bold leading-[1.08] tracking-tight text-[#f4efe3] sm:text-[3rem]">An Official Record is more than a document.</h1>
