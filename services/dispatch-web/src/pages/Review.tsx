  ...
  return (
    <div>
      <header className="mb-6">
        <h1 className="text-2xl font-bold text-white">Review &amp; Approve</h1>
        <p className="text-sm text-white/50">Documents awaiting governance. Approve to release into rendering.</p>
      </header>
