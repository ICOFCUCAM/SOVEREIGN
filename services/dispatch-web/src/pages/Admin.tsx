...
const Admin: React.FC = () => {
  const [tab, setTab] = useState<"clients" | "members" | "policies">("clients");
  return (
    <div>
      <header className="mb-6">
        <h1 className="text-2xl font-bold text-white">Admin</h1>
        <p className="text-sm text-white/50">Service clients, member roles &amp; clearance, approval policies.</p>
      </header>
      <div className="mb-6 flex gap-1 border-b border-white/10">
        {(["clients", "members", "policies"] as const).map((t) => (
