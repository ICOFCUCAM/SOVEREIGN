...
import {
  ...
  COST_ROUTE, LIFECYCLE_ROUTE, ROI_ROUTE, INDUSTRIES_ROUTE,
} from "../lib/routes";
  ...
  <footer className="relative overflow-hidden border-t border-white/[0.06] px-5 py-14 sm:px-8 lg:px-12">
    ...
    <div className="relative mx-auto max-w-[1500px]">
      <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1fr_1fr]">
        ...
        <FooterCol title="Platform" links={[["Overview", PLATFORM_ROUTE], ["Industries", INDUSTRIES_ROUTE], ["Developers", DEVELOPERS_ROUTE], ["Security", SECURITY_ROUTE], ["Compliance", COMPLIANCE_ROUTE]]} />
