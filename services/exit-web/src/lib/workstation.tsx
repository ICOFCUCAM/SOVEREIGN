...
export const Frame: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className = "" }) => (
  <div className={`relative z-[1] grid grid-cols-1 gap-px overflow-hidden rounded-lg border border-white/10 bg-white/10 shadow-[0_1px_0_rgba(255,255,255,0.04)_inset,0_8px_24px_-12px_rgba(0,0,0,0.6)] lg:grid-cols-12 ${className}`}>
    {children}
  </div>
);
