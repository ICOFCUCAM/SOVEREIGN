...
export const ACQUISITION_HISTORY: readonly AcquisitionEvent[] = [
  ...
  { buyerName: 'Salesforce Acquisition Office', targetName: 'Slack',        announcedDate: '2020-12-01', closedDate: '2021-07-21', headlinePriceUsd: 27_700_000_000, sector: 'enterprise_saas', targetGeography: 'US', status: 'closed',    sourceRefs: [{ kind: 'edgar_8k', ref: '0001193125-20-308329' }, { kind: 'wikidata', ref: 'Q5374271' }], confidence: 'unverified' },
  { buyerName: 'Salesforce Acquisition Office', targetName: 'Tableau',      announcedDate: '2019-06-10', closedDate: '2019-08-01', headlinePriceUsd: 15_700_000_000, sector: 'enterprise_saas', targetGeography: 'US', status: 'closed',    sourceRefs: [{ kind: 'edgar_8k', ref: '0001193125-19-170949' }], confidence: 'unverified' },
  { buyerName: 'Salesforce Acquisition Office', targetName: 'MuleSoft',     announcedDate: '2018-03-20', closedDate: '2018-05-02', headlinePriceUsd: 6_500_000_000,  sector: 'enterprise_saas', targetGeography: 'US', status: 'closed',    sourceRefs: [{ kind: 'edgar_8k', ref: '0001193125-18-088847' }], confidence: 'unverified' },
  ...
  // ── Microsoft ──────────────────────────────────────────────────────
  { buyerName: 'Microsoft Industry Solutions', targetName: 'Activision Blizzard', announcedDate: '2022-01-18', closedDate: '2023-10-13', headlinePriceUsd: 68_700_000_000, sector: 'media_content', targetGeography: 'US', status: 'closed', sourceRefs: [{ kind: 'edgar_8k', ref: '0001193125-22-012373' }, { kind: 'wikidata', ref: 'Q210031' }], confidence: 'unverified' },
  { buyerName: 'Microsoft Industry Solutions', targetName: 'Nuance Communications', announcedDate: '2021-04-12', closedDate: '2022-03-04', headlinePriceUsd: 19_700_000_000, sector: 'ai_infra', targetGeography: 'US', status: 'closed', sourceRefs: [{ kind: 'edgar_8k', ref: '0001193125-21-118123' }], confidence: 'unverified' },
  { buyerName: 'Microsoft Industry Solutions', targetName: 'LinkedIn', announcedDate: '2016-06-13', closedDate: '2016-12-08', headlinePriceUsd: 26_200_000_000, sector: 'enterprise_saas', targetGeography: 'US', status: 'closed', sourceRefs: [{ kind: 'edgar_8k', ref: '0001193125-16-628356' }], confidence: 'unverified' },
  ...
  { buyerName: 'Vista Enterprise Software Bolt-On', targetName: 'Cvent',       announcedDate: '2023-03-14', closedDate: '2023-06-15', headlinePriceUsd: 4_600_000_000, sector: 'enterprise_saas', targetGeography: 'US', status: 'closed', sourceRefs: [{ kind: 'edgar_8k', ref: '0001863035-23-000034' }], confidence: 'unverified' },
  ...
  { buyerName: 'Vista Enterprise Software Bolt-On', targetName: 'Avalara',     announcedDate: '2022-08-08', closedDate: '2022-10-19', headlinePriceUsd: 8_400_000_000, sector: 'vertical_saas',   targetGeography: 'US', status: 'closed', sourceRefs: [{ kind: 'edgar_8k', ref: '0001405495-22-000147' }], confidence: 'unverified' },

  // ── Thoma Bravo ────────────────────────────────────────────────────
  { buyerName: 'Thoma Bravo Software Buy-out', targetName: 'Anaplan',      announcedDate: '2022-03-20', closedDate: '2022-06-21', headlinePriceUsd: 10_700_000_000, sector: 'enterprise_saas', targetGeography: 'US', status: 'closed', sourceRefs: [{ kind: 'edgar_8k', ref: '0001616318-22-000018' }], confidence: 'unverified' },
  { buyerName: 'Thoma Bravo Software Buy-out', targetName: 'Coupa',        announcedDate: '2022-12-12', closedDate: '2023-02-28', headlinePriceUsd: 8_000_000_000,  sector: 'enterprise_saas', targetGeography: 'US', status: 'closed', sourceRefs: [{ kind: 'edgar_8k', ref: '0001385867-22-000241' }], confidence: 'unverified' },
  { buyerName: 'Thoma Bravo Software Buy-out', targetName: 'SailPoint',    announcedDate: '2022-04-11', closedDate: '2022-08-16', headlinePriceUsd: 6_900_000_000,  sector: 'enterprise_saas', targetGeography: 'US', status: 'closed', sourceRefs: [{ kind: 'edgar_8k', ref: '0001627475-22-000059' }], confidence: 'unverified' },
  { buyerName: 'Thoma Bravo Software Buy-out', targetName: 'Ping Identity', announcedDate: '2022-08-03', closedDate: '2022-10-18', headlinePriceUsd: 2_800_000_000,  sector: 'enterprise_saas', targetGeography: 'US', status: 'closed', sourceRefs: [{ kind: 'edgar_8k', ref: '0001721947-22-000089' }], confidence: 'unverified' },
  ...
  { buyerName: 'Uber Acquisitions', targetName: 'Postmates',          announcedDate: '2020-07-06', closedDate: '2020-12-01', headlinePriceUsd: 2_650_000_000, sector: 'consumer_marketplace', targetGeography: 'US', status: 'closed', sourceRefs: [{ kind: 'edgar_8k', ref: '0001543151-20-000089' }], confidence: 'unverified' },
  ...
  { buyerName: 'Amazon Strategic', targetName: 'One Medical', announcedDate: '2022-07-21', closedDate: '2023-02-22', headlinePriceUsd: 3_900_000_000, sector: 'consumer_marketplace', targetGeography: 'US', status: 'closed', sourceRefs: [{ kind: 'edgar_8k', ref: '0001018724-22-000071' }], confidence: 'unverified' },
