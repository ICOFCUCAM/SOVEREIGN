// Sample cap-table used by captable tests + the SPA Investors page.

export const SAMPLE_CAPTABLE = {
  companyId: 'cmp-1',
  ...
  shareClasses: [
    ...
    { id: 'sc-warrants',    name: 'Founder warrants (Series A)', kind: 'warrants', authorized: 300_000,   outstanding: 300_000, exercisePriceUsd: 4.5 },
  ],
  stakeholders: [
