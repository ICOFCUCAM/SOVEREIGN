  ...
  <section className="relative overflow-hidden">
    ...
    <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-32 sm:py-44 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <Link to="/deploy" className="inline-flex items-center justify-center gap-2 px-9 py-4 rounded-xl border border-white/15 bg-white/[0.03] text-white font-semibold text-lg hover:bg-white/5 transition-all">
