        ...
        <div className="relative rounded-2xl overflow-hidden border border-white/10 bg-[#04060f]" style={{ aspectRatio: '16 / 9' }}>
          ...
          {videoId ? (
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-8">
              ...
              {onBrief && (
                <button onClick={onBrief} className="inline-flex items-center gap-2 mt-6 px-6 py-3 rounded-xl text-white text-sm font-semibold transition-all hover:-translate-y-px"
                  style={{ background: `linear-gradient(135deg, ${accent}, #7C4DFF)`, boxShadow: `0 0 30px ${accent}33` }}>
                  Request executive briefing <ArrowUpRight className="w-4 h-4" />
                </button>
              )}
            </div>
          )}
