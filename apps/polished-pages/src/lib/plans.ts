...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    cadence: "/ month",
    priceMonthly: 19,
    target: "Authors, parents, individual creators",
    imageCredits: 250,
    textLabel: "Unlimited",
    checkout: "subscription",
    features: [
  ...
  },
  {
    ...
    cadence: "/ month",
    priceMonthly: 39,
    target: "Serious authors, consultants, educators",
    imageCredits: 800,
    textLabel: "Unlimited",
    checkout: "subscription",
    highlight: true,
  ...
  },
  {
    ...
    cadence: "/ month",
    priceMonthly: 59,
    target: "People producing many books",
    imageCredits: 1500,
    textLabel: "Unlimited",
    checkout: "subscription",
    features: [
      ...
      "KDP & IngramSpark bundles",
      "Marketplace storefront & author profile",
      "Series management",
    ],
  },
  {
    ...
    cadence: "/ month",
    priceMonthly: 99,
    target: "Publishers, agencies, educational businesses",
    imageCredits: 4000,
    textLabel: "Unlimited",
    checkout: "subscription",
    features: [
      "Everything in Publisher Pro",
  ...
  },
  {
    ...
    cadence: "/ year",
    priceMonthly: null,
    target: "Schools, NGOs, homeschool organizations",
    imageCredits: null,
    textLabel: "Unlimited",
    checkout: "contact",
    features: [
  ...
  },
  {
    ...
    cadence: "",
    priceMonthly: null,
    target: "Ministries, publishers, government programs",
    imageCredits: null,
    textLabel: "Unlimited",
    checkout: "contact",
    features: [
