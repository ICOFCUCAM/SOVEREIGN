...
// Institutional close — briefing first, plan second.
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-28">
        ...
        >
          ...
          <div className="relative grid items-center gap-10 px-10 py-16 sm:px-14 sm:py-20 lg:grid-cols-[1.3fr_1fr]">
            <div>
              <div className="text-[10px] tracking-[0.32em] text-emrg-mute">BEGIN</div>
              <h2 className="mt-4 font-serif text-4xl font-medium leading-[1.02] text-emrg-ink sm:text-6xl">
                Operate the <span className="wordmark-cream italic">substrate.</span>
              </h2>
              <p className="mt-6 max-w-md text-sm leading-relaxed text-emrg-mute">
                Strategic communications infrastructure for the institutions that define them.
              </p>
            </div>
            <div className="flex flex-wrap items-center gap-5 lg:justify-end">
              ...
              <Link href="/pricing" className="inline-flex items-center gap-2 text-sm text-emrg-ink transition hover:text-emrg-cream">
                Choose a plan
